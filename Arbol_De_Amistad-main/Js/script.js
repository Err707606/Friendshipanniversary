...
function showDedicationText() { 
  ...
  if (!text) {
    text = `Hii, i just wanted to say happy friendship anniversary. Thank you so much for being my friend and being kind to me, i'll always remember you and you will always have a special place in my heart even when we have to separate paths. ᓚ₍⑅^..^₎♡`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "With love, a tired Emma. ʕ˶´• ᴥ •`˶ʔ     ";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-06-14T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-06-14T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `We've been friends for: <b>${days}</b> días<br>` +
      `Our anniversary is in: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
